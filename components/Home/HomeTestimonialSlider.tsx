...
const HomeTestimonialSlider: React.FC = (): JSX.Element => {
  const testimonialData: MT.TestimonialProps[] = [
    ...
    },
    {
      ...
      role: 'Director of Organic Growth & Retention, Colleague',
    ...
    },
    {
      ...
      role: 'Lead Product Manager, Manager',
    ...
    },
    {
      ...
      role: 'Senior Staff Engineer, Colleague',
    ...
    {
      author: 'Ryan Stanley',
      role: 'SEO & Content Marketing Strategist, Colleague',
